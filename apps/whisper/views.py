...
def travel(request):
    ...
    return render(request, 'whisper/travelplan.html', context)
...
def addplan(request):
    if 'id' not in request.session:
        ...
        return render(request, 'whisper/addplan.html', context)
...
def show(request, travel_id):
    ...
    return render(request, 'whisper/showdetail.html', context)
